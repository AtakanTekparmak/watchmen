...
description: Use when scanning a Linux system for persistence artifacts — crontab, systemd units, LD_PRELOAD, shell rc files, SSH authorized_keys, kernel modules.
version: 1.0.0
author: mukul975 (Anthropic-Cybersecurity-Skills)
license: Apache-2.0
metadata:
  hermes:
    tags: [linux, persistence, forensics, security, bash]
mitre_attack:
  - T1053.003
  - T1543.002
  - T1574.006
