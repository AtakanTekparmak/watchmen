...
version: "1.0"
author: mahipal (mukul975/Anthropic-Cybersecurity-Skills)
license: Apache-2.0
source_url: https://github.com/mukul975/Anthropic-Cybersecurity-Skills/tree/main/skills/analyzing-persistence-mechanisms-in-linux
source: upstream
...
See `references/api-reference.md` for the underlying shell commands each
scan step wraps.
